...
public class CommanderRegisterFrag extends Fragment {
    ...
    public void onStart() {
        ...
        String isdashboradtutorial=pref.getString("CommaderNote","");
    ...
    private void tutorialstart() {
        TapTargetView.showFor(getActivity(),              // `this` is an Activity
                TapTarget.forView(getActivity().findViewById(R.id.user_login_PhoneNo), "Commander", "commander is mid communicator between donor and receiver  ,\n" +
                        "if your willing to become an commander and \n" +
                        "want to contribute\n" +
                        "then you can register and request for being commander")
                ...
                new TapTargetView.Listener() {          // The listener can listen for regular clicks, long clicks or cancels
                    ...
                    public void onTargetClick(TapTargetView view) {
                        ...
                        editor.putString("CommaderNote", "1");//1 value will note as user as seen intro
                        editor.apply();
                        //  Toast.makeText(
                    }
