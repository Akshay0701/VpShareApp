...
public class User_QrScan extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book_cb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                donated +="Books ";
            }
        });
        pencil_cn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                donated +="Pencil ";
            }
        });
        marker_cn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                donated +="Maker ";
            }
        });
        sarnpner_cn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                donated +="Pencil Sarpner ";
            }
        });
        other_cn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                donated +="Other Stuff ";
            }
        ...
        startScan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!donated.equals("")) {
                    ...
                    Toast.makeText(User_QrScan.this, "please select what your going to donate", Toast.LENGTH_SHORT).show();
                }
              // scannerView.startCamera();
            }
        });
            ...
            ref.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot ds : dataSnapshot.getChildren()) {
                        ...
                        // here commander  of that bagscode not found thats why its showing eror
