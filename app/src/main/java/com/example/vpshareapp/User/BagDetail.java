            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (status.equals("0")) {
                        ...
                        if (status.equals("0")) {
                            location1 = "0";
                       //     Toast.makeText(getContext(), "get location from user and store to firebase", Toast.LENGTH_SHORT).show();
                        } else {
                            location1 = "1";
                         //   Toast.makeText(getContext(), "get location from firebase", Toast.LENGTH_SHORT).show();
                        }
