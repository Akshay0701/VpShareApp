...
import com.example.vpshareapp.Model.ModelDonationRequest;
...
public class AllSchoolDetails extends Fragment {
    ...
    List<ModelDonationRequest> schoolList;
    ...
    private void getallSchool() {
        ...
        DatabaseReference ref= FirebaseDatabase.getInstance().getReference("DonationRequest");
        ref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                schoolList.clear();
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ModelDonationRequest modelDonationRequest= ds.getValue(ModelDonationRequest.class);


                    schoolList.add(modelDonationRequest);
